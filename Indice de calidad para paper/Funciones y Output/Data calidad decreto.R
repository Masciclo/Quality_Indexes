...
GetQualityDecreto <- function(df){
    ...
    mutate(
      tip_op_sup =
        case_when(
          ...
          #Ancho bidirecional
          (ci_o_cr == 1)  & (oneway == 0) &(ancho_v < 220) ~ 1,
          (ci_o_cr == 1)  & (oneway == 1) &(ancho_v < 150) ~ 1,
          TRUE ~ 0),

      tip_op_seg_ca =
        case_when(
          (ci_o_cr == 1) & (ci_ca == 1) & tip_via_ci <= 2 & ancho_s < 60 & t_seg_ca < 2 ~ 1,
          (ci_o_cr == 1) & (ci_ca == 1) & tip_via_ci == (3||4)  & ancho_s < 50 & t_seg_ca < 3 ~ 1,
          (ci_o_cr == 1) & (ci_ca == 1) & tip_via_ci >= 5  & ancho_s <= 0 ~ 1,
          TRUE ~ 0),
  ...
  # Write data index
  readr::write_csv(index, "output/data calidad merkuria/index.csv")
  ...
  # Write data tabla 4
  readr::write_csv(inop_op_tipo, "output/data calidad merkuria/4_tipo_inoperatividad.csv")
  ...
  # Write data tabla 5a
  readr::write_csv(tabla_5a, "output/data calidad merkuria/5.a_distibucion_km_operativos_inoperativos.csv")
  ...
  # Write data tabla 5b
  readr::write_csv(tabla_5b, "output/data calidad merkuria/5.b_distibucion_km_operativos_inoperativos_por_comuna.csv")
  ...
  # Write data tabla 6a
  readr::write_csv(tabla_6a , "output/data calidad merkuria/6.a_distibucion_km_ciclovias_operativos_inoperativos.csv")
  ...
  readr::write_csv(tabla_6b, "output/data calidad merkuria/6.b_distibucion_km_ciclovias_operativos_inoperativos.csv")
  ...
  # Write data tabla 7a
  readr::write_csv(tabla_7a, "output/data calidad merkuria/7.a_distibucion_km_tipo_inoperatividad.csv")
  ...
  # Write data tabla 7b
  readr::write_csv(tabla_7b, "output/data calidad merkuria/7.b_distibucion_km_tipo_inoperatividad_comuna.csv")
  ...
  # Write data tabla 8a
  readr::write_csv(tabla_8a, "output/data calidad merkuria/8.a_distibucion_km_tipo_inoperatividad_cruces.csv")
  ...
  # Write data tabla 8b
  readr::write_csv(tabla_8b, "output/data calidad merkuria/8.b_distibucion_km_tipo_inoperatividad_cruces_comuna.csv")
